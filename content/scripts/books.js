...
const BOOK_META_DATA = [
    {
        id:"family-relics-trilogy",
        title: "Family Relics Trilogy",
        subtitle: "",
        image:"/images/FamilyRelicsSet.jpg",
        shortblurb: "All three exciting novels in the Family Relics Trilogy are available in one eBook box set.<br/><br/><b>THE BOX OF SOULS<br/>THE ONYX RING<br/>THE DRAGON AMULET</b><br/><br/>",
        fullblurb: "All three exciting novels in the Family Relics Trilogy are available in one eBook box set.<br/><br/><b>THE BOX OF SOULS<br/>THE ONYX RING<br/>THE DRAGON AMULET</b><br/><br/>" +
                "&quot;Tanya Miranda has a definite story-telling ability and I can definitely recommend this book to fans of the fantasy genre, or just plain action/adventure fans.&quot;<br/><i>— 5-STAR Review of The Onyx Ring on Reader's Favorite</i><br/><br/>" + 
                "&quot;Tanya Miranda crafts a magnificent world full of lore and magic that feels authentic as well as imaginative. The narrative is action-packed with a plot that moves at a blistering pace, taking unexpected twists and turns to keep your eyes glued to the pages.&quot;<br/> — 5-STAR Review of The Dragon Amulet on Reader's Favorite",
        shoplink: "",
        amazon: "https://amzn.to/3UGsXAQ",
        nook: "",
        ibooks: "",
        google: "",
        smashwords: "",
        kobo: "",
        displayBookImageWithoutShadow: true,
        hideFromBookList: true
    },
    {
    ...
    
    {
        ...
        image:"/images/books-OutsideTheLines.jpg",
        tagline: "",
...
function loadBookVendorLinks() {
    ...
    if (!GO_WIDE) {
        html += "<p><center><div class='myStoreButton'><a href='https://amzn.to/3UoMI0b' >Buy now on Amazon!</a></div></center></p>"
    }
    else{
        ...
        html += "<p class='cozy-message'>Support an independent author and small business owner by purchasing your copy at my shop!</p>" + 
            ...
            "<div id='all-books-footer'>" +
                "<div>" +
                    "<a href='https://amzn.to/3UoMI0b' target='_blank'><img class='bookSellerButton' src='https://tanyamiranda.github.io/content/images/store-amazon.png'></a>" +
